...
const CreateSurvey = () => {
  ...
  const saveDraft = async () => {
    ...
    const result = await createSurvey(draftData);
  ...
  const publishSurvey = async () => {
    ...
    const result = await createSurvey(publishData);
    ...
    <>
      ...
      <div className="survey-hero">
        <div className="survey-header">
          ...
          <p className="survey-subtitle">Design engaging surveys to collect valuable feedback</p>
        </div>
